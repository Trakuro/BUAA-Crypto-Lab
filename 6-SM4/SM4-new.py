...
class SM4:
    ...
    CK = [
        ...
        0x30373E45, 0x484F565D, 0x646B7279, 0x848B9299,
    ...
    def bytes_to_int_list(b: bytes) -> List[int]:
        return [
            int.from_bytes(b[i : i + 4], byteorder="big") for i in range(0, len(b), 4)
        ]

    @staticmethod
    def int_list_to_bytes(lst: list) -> bytes:
        return b"".join(x.to_bytes(4, byteorder="big") for x in lst)
